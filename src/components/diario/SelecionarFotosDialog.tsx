        ...
        <DialogHeader>
          ...
          <DialogDescription>
            {hasFotos 
              ...
              : 'Este registro não possui fotos. Você pode exportar o PDF apenas com texto.'
            }
          </DialogDescription>
        </DialogHeader>
          ...
          {hasFotos ? (
            ...
            <div className="flex flex-col items-center justify-center py-8 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                O PDF será gerado apenas com as informações de texto do diário.
              </p>
            </div>
          )}

          {/* Lista de fotos - só mostra se tiver fotos */}
          {hasFotos && (
                  ...
                  >
                    ...
                    <div className="flex-1 space-y-1">
                      ...
                      <Input
                        ...
                        disabled={!foto.selecionada || isLoading}
          ...
          <Button onClick={handleConfirm} disabled={isLoading}>
            {isLoading ? (
              ...
              <>
                ...
                Exportar {quantidadeSelecionada > 0 ? `${quantidadeSelecionada} foto(s)` : 'sem fotos'}
              </>
            ) : (
              <>
