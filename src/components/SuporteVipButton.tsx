    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <a
          ...
          className="fixed bottom-24 right-6 z-50 w-14 h-14 bg-amber-500 hover:bg-amber-600 rounded-full flex items-center justify-center shadow-lg transition-all hover:scale-110 active:scale-95 ring-2 ring-amber-300/50"
